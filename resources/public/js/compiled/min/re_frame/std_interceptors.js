...
var vec__23107_23110 = clojure.data.diff(orig_db,new_db);
var only_before_23111 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23107_23110,(0),null);
var only_after_23112 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23107_23110,(1),null);
var db_changed_QMARK__23113 = (!((only_before_23111 == null))) || (!((only_after_23112 == null)));
if(db_changed_QMARK__23113){
...
re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(cljs.core.cst$kw$log,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["only before:",only_before_23111], 0));

re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(cljs.core.cst$kw$log,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["only after :",only_after_23112], 0));
...
var map__23114 = cljs.core.cst$kw$coeffects.cljs$core$IFn$_invoke$arity$1(context);
...
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23114__$1,cljs.core.cst$kw$event);
...
var map__23116 = cljs.core.cst$kw$coeffects.cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__23116__$1;
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23116__$1,cljs.core.cst$kw$event);
...
var len__12081__auto___23119 = arguments.length;
var i__12082__auto___23120 = (0);
while(true){
if((i__12082__auto___23120 < len__12081__auto___23119)){
args__12088__auto__.push((arguments[i__12082__auto___23120]));

var G__23121 = (i__12082__auto___23120 + (1));
i__12082__auto___23120 = G__23121;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__12089__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq23118){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq23118));
});
...
var event = re_frame.interceptor.get_coeffect.cljs$core$IFn$_invoke$arity$2(context,cljs.core.cst$kw$event);
var db = (function (){var or__10921__auto__ = re_frame.interceptor.get_effect.cljs$core$IFn$_invoke$arity$2(context,cljs.core.cst$kw$db);
...
var args__12088__auto__ = [];
var len__12081__auto___23127 = arguments.length;
var i__12082__auto___23128 = (0);
while(true){
if((i__12082__auto___23128 < len__12081__auto___23127)){
args__12088__auto__.push((arguments[i__12082__auto___23128]));

var G__23129 = (i__12082__auto___23128 + (1));
i__12082__auto___23128 = G__23129;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__12089__auto__);
});
...
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(new_db,p1__23122_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (new_db,old_db,new_ins){
return (function (p1__23123_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(old_db,p1__23123_SHARP_);
});})(new_db,old_db,new_ins))
,in_paths);
var changed_ins_QMARK_ = (function (){var and__10909__auto__ = cljs.core.contains_QMARK_(re_frame.interceptor.get_effect.cljs$core$IFn$_invoke$arity$1(context),cljs.core.cst$kw$db);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq23124){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__23125,G__23126,seq23124__$2);
});
