...
if(cljs.core.truth_((function (){var and__10909__auto__ = new_index;
...
var G__21794 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(choices,new_index);
return (id_fn.cljs$core$IFn$_invoke$arity$1 ? id_fn.cljs$core$IFn$_invoke$arity$1(G__21794) : id_fn.call(null,G__21794));
} else {
return null;
}
});
...
return cljs.core.PersistentHashMap.fromArrays([cljs.core.cst$kw$id,cljs.core.cst$kw$group],[cljs.core.gensym.cljs$core$IFn$_invoke$arity$0(),p1__21795_SHARP_]);
});})(groups))
...
var or__10921__auto__ = re__$1.test((group_fn.cljs$core$IFn$_invoke$arity$1 ? group_fn.cljs$core$IFn$_invoke$arity$1(opt) : group_fn.call(null,opt)));
...
var new_scroll_top = (((item_offset_bottom > parent_visible_bottom))?(function (){var x__11271__auto__ = (item_offset_bottom - parent_height);
var y__11272__auto__ = (0);
...
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.dropdown.choice_item,id,markup,callback,internal_model], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(id)].join('')], null));
});
/**
...
var G__21797_21798 = event.target.value;
(set_filter_text.cljs$core$IFn$_invoke$arity$1 ? set_filter_text.cljs$core$IFn$_invoke$arity$1(G__21797_21798) : set_filter_text.call(null,G__21797_21798));
 ...
 */
re_com.dropdown.filter_text_box = cljs.core.with_meta(re_com.dropdown.filter_text_box_base,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$component_DASH_did_DASH_mount,(function (p1__21799_SHARP_){
var node = reagent.core.dom_node(p1__21799_SHARP_).firstChild;
return node.focus();
}),cljs.core.cst$kw$component_DASH_did_DASH_update,(function (p1__21800_SHARP_){
var node = reagent.core.dom_node(p1__21800_SHARP_).firstChild;
return node.focus();
})], null));
/**
...
var text = (cljs.core.truth_(cljs.core.deref(internal_model))?(function (){var G__21801 = re_com.util.item_for_id.cljs$core$IFn$_invoke$arity$variadic(cljs.core.deref(internal_model),choices,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.cst$kw$id_DASH_fn,id_fn], 0));
return (label_fn.cljs$core$IFn$_invoke$arity$1 ? label_fn.cljs$core$IFn$_invoke$arity$1(G__21801) : label_fn.call(null,G__21801));
})():placeholder);
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$a$chosen_DASH_single$chosen_DASH_default,new cljs.core.PersistentArrayMap(null, 5, [cljs.core.cst$kw$href,"javascript:",cljs.core.cst$kw$tab_DASH_index,(cljs.core.truth_(tab_index)?tab_index:null),cljs.core.cst$kw$on_DASH_click,((function (_,text,ignore_click){
return (function (event){
...
var or__10921__auto__ = cljs.core.fn_QMARK_(v);
...
return (function (p__21804){
var map__21805 = p__21804;
var map__21805__$1 = ((((!((map__21805 == null)))?((((map__21805.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21805.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__21805):map__21805);
var args = map__21805__$1;
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21805__$1,cljs.core.cst$kw$result);
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21805__$1,cljs.core.cst$kw$error);
...
var G__21807 = new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$filter_DASH_text,text,cljs.core.cst$kw$regex_DASH_filter_QMARK_,regex_filter_QMARK_], null);
var G__21808 = ((function (G__21807,id,callback){
return (function (p1__21802_SHARP_){
return callback(new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$result,p1__21802_SHARP_], null));
});})(G__21807,id,callback))
;
var G__21809 = ((function (G__21807,G__21808,id,callback){
return (function (p1__21803_SHARP_){
return callback(new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$error,p1__21803_SHARP_], null));
});})(G__21807,G__21808,id,callback))
;
return (choices.cljs$core$IFn$_invoke$arity$3 ? choices.cljs$core$IFn$_invoke$arity$3(G__21807,G__21808,G__21809) : choices.call(null,G__21807,G__21808,G__21809));
});
/**
...
var temp__4657__auto___21812 = cljs.core.cst$kw$timer.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(choices_state));
if(cljs.core.truth_(temp__4657__auto___21812)){
var timer_21813 = temp__4657__auto___21812;
clearTimeout(timer_21813);
} else {
}

if(cljs.core.truth_(debounce_QMARK_)){
var timer = (function (){var G__21810 = (function (){
return re_com.dropdown.load_choices_STAR_(choices_state,choices,text,regex_filter_QMARK_);
});
var G__21811 = debounce_delay;
return setTimeout(G__21810,G__21811);
})();
...
var len__12081__auto___21834 = arguments.length;
var i__12082__auto___21835 = (0);
while(true){
if((i__12082__auto___21835 < len__12081__auto___21834)){
args__12088__auto__.push((arguments[i__12082__auto___21835]));

var G__21836 = (i__12082__auto___21835 + (1));
i__12082__auto___21835 = G__21836;
continue;
} else {
}
break;
...
return re_com.dropdown.single_dropdown.cljs$core$IFn$_invoke$arity$variadic(argseq__12089__auto__);
});

re_com.dropdown.single_dropdown.cljs$core$IFn$_invoke$arity$variadic = (function (p__21819){
...
var args = map__21820__$1;
var choices = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21820__$1,cljs.core.cst$kw$choices);
var model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21820__$1,cljs.core.cst$kw$model);
var regex_filter_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21820__$1,cljs.core.cst$kw$regex_DASH_filter_QMARK_);
var debounce_delay = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__21820__$1,cljs.core.cst$kw$debounce_DASH_delay,(250));
...
var set_filter_text = ((function (external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,map__21820,map__21820__$1,args,choices,model,regex_filter_QMARK_,debounce_delay){
return (function (text,p__21822,debounce_QMARK_){
...
var args__$1 = map__21823__$1;
var regex_filter_QMARK___$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21823__$1,cljs.core.cst$kw$regex_DASH_filter_QMARK_);
...
});})(external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,map__21820,map__21820__$1,args,choices,model,regex_filter_QMARK_,debounce_delay))
;
...
return ((function (external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__21820,map__21820__$1,args,choices,model,regex_filter_QMARK_,debounce_delay){
return (function() { 
var G__21837__delegate = function (p__21825){
...
var args__$1 = map__21826__$1;
var group_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__21826__$1,cljs.core.cst$kw$group_DASH_fn,cljs.core.cst$kw$group);
var disabled_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21826__$1,cljs.core.cst$kw$disabled_QMARK_);
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21826__$1,cljs.core.cst$kw$on_DASH_change);
var model__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21826__$1,cljs.core.cst$kw$model);
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21826__$1,cljs.core.cst$kw$attr);
var label_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__21826__$1,cljs.core.cst$kw$label_DASH_fn,cljs.core.cst$kw$label);
var tab_index = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21826__$1,cljs.core.cst$kw$tab_DASH_index);
var max_height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21826__$1,cljs.core.cst$kw$max_DASH_height);
var placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21826__$1,cljs.core.cst$kw$placeholder);
var title_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21826__$1,cljs.core.cst$kw$title_QMARK_);
var render_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__21826__$1,cljs.core.cst$kw$render_DASH_fn,label_fn);
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21826__$1,cljs.core.cst$kw$width);
var regex_filter_QMARK___$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21826__$1,cljs.core.cst$kw$regex_DASH_filter_QMARK_);
var choices__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21826__$1,cljs.core.cst$kw$choices);
var id_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__21826__$1,cljs.core.cst$kw$id_DASH_fn,cljs.core.cst$kw$id);
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21826__$1,cljs.core.cst$kw$style);
var debounce_delay__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21826__$1,cljs.core.cst$kw$debounce_DASH_delay);
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21826__$1,cljs.core.cst$kw$class);
var filter_box_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21826__$1,cljs.core.cst$kw$filter_DASH_box_QMARK_);
...
:null);
var changeable_QMARK_ = (function (){var and__10909__auto__ = on_change;
if(cljs.core.truth_(and__10909__auto__)){
...
var callback = ((function (choices__$2,disabled_QMARK___$1,regex_filter_QMARK___$2,latest_ext_model,_,changeable_QMARK_,map__21826,map__21826__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK___$1,choices__$1,id_fn,style,debounce_delay__$1,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__21820,map__21820__$1,args,choices,model,regex_filter_QMARK_,debounce_delay){
return (function (p1__21814_SHARP_){
cljs.core.reset_BANG_(internal_model,p1__21814_SHARP_);

if(cljs.core.truth_((function (){var and__10909__auto__ = changeable_QMARK_;
if(cljs.core.truth_(and__10909__auto__)){
...
var G__21828_21838 = cljs.core.deref(internal_model);
(on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__21828_21838) : on_change.call(null,G__21828_21838));
} else {
}
...
});})(choices__$2,disabled_QMARK___$1,regex_filter_QMARK___$2,latest_ext_model,_,changeable_QMARK_,map__21826,map__21826__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK___$1,choices__$1,id_fn,style,debounce_delay__$1,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__21820,map__21820__$1,args,choices,model,regex_filter_QMARK_,debounce_delay))
;
var cancel = ((function (choices__$2,disabled_QMARK___$1,regex_filter_QMARK___$2,latest_ext_model,_,changeable_QMARK_,callback,map__21826,map__21826__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK___$1,choices__$1,id_fn,style,debounce_delay__$1,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__21820,map__21820__$1,args,choices,model,regex_filter_QMARK_,debounce_delay){
return (function (){
cljs.core.reset_BANG_(drop_showing_QMARK_,false);
...
});})(choices__$2,disabled_QMARK___$1,regex_filter_QMARK___$2,latest_ext_model,_,changeable_QMARK_,callback,map__21826,map__21826__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK___$1,choices__$1,id_fn,style,debounce_delay__$1,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__21820,map__21820__$1,args,choices,model,regex_filter_QMARK_,debounce_delay))
;
var dropdown_click = ((function (choices__$2,disabled_QMARK___$1,regex_filter_QMARK___$2,latest_ext_model,_,changeable_QMARK_,callback,cancel,map__21826,map__21826__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK___$1,choices__$1,id_fn,style,debounce_delay__$1,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__21820,map__21820__$1,args,choices,model,regex_filter_QMARK_,debounce_delay){
return (function (){
...
var press_enter = ((function (choices__$2,disabled_QMARK___$1,regex_filter_QMARK___$2,latest_ext_model,_,changeable_QMARK_,callback,cancel,dropdown_click,filtered_choices,map__21826,map__21826__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK___$1,choices__$1,id_fn,style,debounce_delay__$1,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__21820,map__21820__$1,args,choices,model,regex_filter_QMARK_,debounce_delay){
return (function (){
if(cljs.core.truth_(disabled_QMARK___$1)){
cancel();
} else {
...
;
var press_escape = ((function (choices__$2,disabled_QMARK___$1,regex_filter_QMARK___$2,latest_ext_model,_,changeable_QMARK_,callback,cancel,dropdown_click,filtered_choices,press_enter,map__21826,map__21826__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK___$1,choices__$1,id_fn,style,debounce_delay__$1,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__21820,map__21820__$1,args,choices,model,regex_filter_QMARK_,debounce_delay){
return (function (){
cancel();
...
;
var press_tab = ((function (choices__$2,disabled_QMARK___$1,regex_filter_QMARK___$2,latest_ext_model,_,changeable_QMARK_,callback,cancel,dropdown_click,filtered_choices,press_enter,press_escape,map__21826,map__21826__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK___$1,choices__$1,id_fn,style,debounce_delay__$1,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__21820,map__21820__$1,args,choices,model,regex_filter_QMARK_,debounce_delay){
return (function (){
if(cljs.core.truth_(disabled_QMARK___$1)){
cancel();
} else {
if(cljs.core.truth_(changeable_QMARK_)){
var G__21829_21839 = cljs.core.deref(internal_model);
(on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__21829_21839) : on_change.call(null,G__21829_21839));
} else {
}
...
;
var press_up = ((function (choices__$2,disabled_QMARK___$1,regex_filter_QMARK___$2,latest_ext_model,_,changeable_QMARK_,callback,cancel,dropdown_click,filtered_choices,press_enter,press_escape,press_tab,map__21826,map__21826__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK___$1,choices__$1,id_fn,style,debounce_delay__$1,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__21820,map__21820__$1,args,choices,model,regex_filter_QMARK_,debounce_delay){
return (function (){
if(cljs.core.truth_(cljs.core.deref(drop_showing_QMARK_))){
...
;
var press_down = ((function (choices__$2,disabled_QMARK___$1,regex_filter_QMARK___$2,latest_ext_model,_,changeable_QMARK_,callback,cancel,dropdown_click,filtered_choices,press_enter,press_escape,press_tab,press_up,map__21826,map__21826__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK___$1,choices__$1,id_fn,style,debounce_delay__$1,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__21820,map__21820__$1,args,choices,model,regex_filter_QMARK_,debounce_delay){
return (function (){
if(cljs.core.truth_(cljs.core.deref(drop_showing_QMARK_))){
cljs.core.reset_BANG_(internal_model,re_com.dropdown.move_to_new_choice(filtered_choices,id_fn,cljs.core.deref(internal_model),(1)));
} else {
...
;
var press_home = ((function (choices__$2,disabled_QMARK___$1,regex_filter_QMARK___$2,latest_ext_model,_,changeable_QMARK_,callback,cancel,dropdown_click,filtered_choices,press_enter,press_escape,press_tab,press_up,press_down,map__21826,map__21826__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK___$1,choices__$1,id_fn,style,debounce_delay__$1,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__21820,map__21820__$1,args,choices,model,regex_filter_QMARK_,debounce_delay){
return (function (){
...
;
var press_end = ((function (choices__$2,disabled_QMARK___$1,regex_filter_QMARK___$2,latest_ext_model,_,changeable_QMARK_,callback,cancel,dropdown_click,filtered_choices,press_enter,press_escape,press_tab,press_up,press_down,press_home,map__21826,map__21826__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK___$1,choices__$1,id_fn,style,debounce_delay__$1,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__21820,map__21820__$1,args,choices,model,regex_filter_QMARK_,debounce_delay){
return (function (){
...
;
var key_handler = ((function (choices__$2,disabled_QMARK___$1,regex_filter_QMARK___$2,latest_ext_model,_,changeable_QMARK_,callback,cancel,dropdown_click,filtered_choices,press_enter,press_escape,press_tab,press_up,press_down,press_home,press_end,map__21826,map__21826__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK___$1,choices__$1,id_fn,style,debounce_delay__$1,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__21820,map__21820__$1,args,choices,model,regex_filter_QMARK_,debounce_delay){
return (function (p1__21815_SHARP_){
if(cljs.core.truth_(disabled_QMARK___$1)){
return false;
} else {
var G__21830 = p1__21815_SHARP_.which;
switch (G__21830) {
case (13):
return press_enter();
...
;
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$class,["rc-dropdown chosen-container chosen-container-single noselect ",cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(cljs.core.deref(drop_showing_QMARK_))?"chosen-container-active chosen-with-drop ":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(class$)].join(''),cljs.core.cst$kw$style,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([re_com.box.flex_child_style((cljs.core.truth_(width)?"0 0 auto":"auto")),re_com.box.align_style(cljs.core.cst$kw$align_DASH_self,cljs.core.cst$kw$start),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$width,(cljs.core.truth_(width)?width:null)], null),style], 0))], null),attr], 0)),new cljs.core.PersistentVector(null, 12, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.dropdown.dropdown_top,internal_model,choices__$2,id_fn,label_fn,tab_index,placeholder,dropdown_click,key_handler,filter_box_QMARK_,drop_showing_QMARK_,title_QMARK_], null),(cljs.core.truth_((function (){var and__10909__auto__ = cljs.core.deref(drop_showing_QMARK_);
if(cljs.core.truth_(and__10909__auto__)){
return cljs.core.not(disabled_QMARK___$1);
} else {
return and__10909__auto__;
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$chosen_DASH_drop,new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.dropdown.filter_text_box,filter_box_QMARK_,filter_text,key_handler,drop_showing_QMARK_,((function (choices__$2,disabled_QMARK___$1,regex_filter_QMARK___$2,latest_ext_model,_,changeable_QMARK_,callback,cancel,dropdown_click,filtered_choices,press_enter,press_escape,press_tab,press_up,press_down,press_home,press_end,key_handler,map__21826,map__21826__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK___$1,choices__$1,id_fn,style,debounce_delay__$1,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__21820,map__21820__$1,args,choices,model,regex_filter_QMARK_,debounce_delay){
return (function (p1__21816_SHARP_){
return set_filter_text(p1__21816_SHARP_,args__$1,true);
});})(choices__$2,disabled_QMARK___$1,regex_filter_QMARK___$2,latest_ext_model,_,changeable_QMARK_,callback,cancel,dropdown_click,filtered_choices,press_enter,press_escape,press_tab,press_up,press_down,press_home,press_end,key_handler,map__21826,map__21826__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK___$1,choices__$1,id_fn,style,debounce_delay__$1,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__21820,map__21820__$1,args,choices,model,regex_filter_QMARK_,debounce_delay))
], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$ul$chosen_DASH_results,(cljs.core.truth_(max_height)?new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$style,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$max_DASH_height,max_height], null)], null):null),(cljs.core.truth_((function (){var and__10909__auto__ = choices_fn_QMARK_;
if(and__10909__auto__){
return cljs.core.cst$kw$loading_QMARK_.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(choices_state));
} else {
return and__10909__auto__;
}
})())?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$li$loading,["Loading..."].join('')], null):(cljs.core.truth_((function (){var and__10909__auto__ = choices_fn_QMARK_;
if(and__10909__auto__){
return cljs.core.cst$kw$error.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(choices_state));
} else {
return and__10909__auto__;
}
})())?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$li$error,cljs.core.cst$kw$error.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(choices_state))], null):(((cljs.core.count(filtered_choices) > (0)))?(function (){var vec__21831 = re_com.dropdown.choices_with_group_headings(filtered_choices,group_fn);
var group_names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21831,(0),null);
var group_opt_lists = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21831,(1),null);
...
var make_choices = ((function (vec__21831,group_names,group_opt_lists,make_a_choice,choices__$2,disabled_QMARK___$1,regex_filter_QMARK___$2,latest_ext_model,_,changeable_QMARK_,callback,cancel,dropdown_click,filtered_choices,press_enter,press_escape,press_tab,press_up,press_down,press_home,press_end,key_handler,map__21826,map__21826__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK___$1,choices__$1,id_fn,style,debounce_delay__$1,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__21820,map__21820__$1,args,choices,model,regex_filter_QMARK_,debounce_delay){
return (function (p1__21817_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(make_a_choice,p1__21817_SHARP_);
});})(vec__21831,group_names,group_opt_lists,make_a_choice,choices__$2,disabled_QMARK___$1,regex_filter_QMARK___$2,latest_ext_model,_,changeable_QMARK_,callback,cancel,dropdown_click,filtered_choices,press_enter,press_escape,press_tab,press_up,press_down,press_home,press_end,key_handler,map__21826,map__21826__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK___$1,choices__$1,id_fn,style,debounce_delay__$1,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__21820,map__21820__$1,args,choices,model,regex_filter_QMARK_,debounce_delay))
;
var make_h_then_choices = ((function (vec__21831,group_names,group_opt_lists,make_a_choice,make_choices,choices__$2,disabled_QMARK___$1,regex_filter_QMARK___$2,latest_ext_model,_,changeable_QMARK_,callback,cancel,dropdown_click,filtered_choices,press_enter,press_escape,press_tab,press_up,press_down,press_home,press_end,key_handler,map__21826,map__21826__$1,args__$1,group_fn,disabled_QMARK_,on_change,model__$1,attr,label_fn,tab_index,max_height,placeholder,title_QMARK_,render_fn,width,regex_filter_QMARK___$1,choices__$1,id_fn,style,debounce_delay__$1,class$,filter_box_QMARK_,external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__21820,map__21820__$1,args,choices,model,regex_filter_QMARK_,debounce_delay){
...
while (G__21841__i < G__21841__a.length) {G__21841__a[G__21841__i] = arguments[G__21841__i + 0]; ++G__21841__i;}
  p__21825 = new cljs.core.IndexedSeq(G__21841__a,0,null);
} 
return G__21837__delegate.call(this,p__21825);};
G__21837.cljs$lang$maxFixedArity = 0;
G__21837.cljs$lang$applyTo = (function (arglist__21842){
var p__21825 = cljs.core.seq(arglist__21842);
return G__21837__delegate(p__21825);
});
G__21837.cljs$core$IFn$_invoke$arity$variadic = G__21837__delegate;
return G__21837;
})()
;
;})(external_model,internal_model,drop_showing_QMARK_,filter_text,choices_fn_QMARK_,choices_state,load_choices,set_filter_text,map__21820,map__21820__$1,args,choices,model,regex_filter_QMARK_,debounce_delay))
});

re_com.dropdown.single_dropdown.cljs$lang$maxFixedArity = (0);

re_com.dropdown.single_dropdown.cljs$lang$applyTo = (function (seq21818){
return re_com.dropdown.single_dropdown.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq21818));
});
