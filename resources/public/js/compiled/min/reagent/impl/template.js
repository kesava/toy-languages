...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__11546__auto__,writer__11547__auto__,opt__11548__auto__){
return cljs.core._write(writer__11547__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__16921 = o;
(G__16921[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
if(cljs.core.truth_((function (){var and__10909__auto__ = !((jsprops == null));
if(and__10909__auto__){
var and__10909__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__16927 = jsprops;
(G__16927["defaultValue"] = value);

(G__16927["onChange"] = ((function (G__16927,v,value,on_change){
return (function (p1__16926_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__16926_SHARP_);
});})(G__16927,v,value,on_change))
);
...
var vec__16930 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16930,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16930,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16930,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___16934 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___16934 == null)){
} else {
var key_16935 = temp__4661__auto___16934;
(jsprops["key"] = key_16935);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__16936 = reagent.impl.template.__GT_NativeWrapper();
(G__16936["name"] = c);
...
var G__16937 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__16937) : reagent.impl.template.as_element.call(null,G__16937));
} else {
...
var len__12081__auto___16941 = arguments.length;
var i__12082__auto___16942 = (0);
while(true){
if((i__12082__auto___16942 < len__12081__auto___16941)){
args__12088__auto__.push((arguments[i__12082__auto___16942]));

var G__16943 = (i__12082__auto___16942 + (1));
i__12082__auto___16942 = G__16943;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__12089__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq16939){
var G__16940 = cljs.core.first(seq16939);
var seq16939__$1 = cljs.core.next(seq16939);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__16940,seq16939__$1);
});
...
break;
default:
var G__16946 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__16946;
continue;
...
var n__11868__auto___16948 = a.length;
var i_16949 = (0);
while(true){
if((i_16949 < n__11868__auto___16948)){
(a[i_16949] = reagent.impl.template.as_element((a[i_16949])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__11868__auto___16951 = a.length;
var i_16952 = (0);
while(true){
if((i_16952 < n__11868__auto___16951)){
var val_16953 = (a[i_16952]);
if((cljs.core.vector_QMARK_(val_16953)) && ((reagent.impl.template.key_from_vec(val_16953) == null))){
(o["no-key"] = true);
} else {
}

(a[i_16952] = reagent.impl.template.as_element(val_16953));

var G__16954 = (i_16952 + (1));
i_16952 = G__16954;
continue;
} else {
}
...
var ctx = ({});
var vec__16955 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16955,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16955,(1),null);
...
var G__16958 = (cljs.core.count(argv) - first_child);
switch (G__16958) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__16958){
