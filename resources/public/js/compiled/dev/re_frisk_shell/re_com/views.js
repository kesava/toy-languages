...
], null),(((trace_QMARK_) && (completed_QMARK_))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get_in.call(null,item,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"trace","trace",-1082747415),new cljs.core.Keyword(null,"duration","duration",1444101068)], null)))," ms "].join('')], null):null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),(cljs.core.truth_((function (){var and__26450__auto__ = cljs.core.deref.call(null,checkbox_val);
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frisk_shell.re_com.ui.scroller,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-scroll","on-scroll",1590848677),(function (p1__34408_SHARP_){
var t = p1__34408_SHARP_.target;
...
})], null),(function (){var iter__27270__auto__ = (function re_frisk_shell$re_com$views$events_scroller_$_iter__34409(s__34410){
...
var c__27268__auto__ = cljs.core.chunk_first.call(null,s__34410__$2);
var size__27269__auto__ = cljs.core.count.call(null,c__27268__auto__);
var b__34412 = cljs.core.chunk_buffer.call(null,size__27269__auto__);
if((function (){var i__34411 = (0);
while(true){
if((i__34411 < size__27269__auto__)){
var item = cljs.core._nth.call(null,c__27268__auto__,i__34411);
cljs.core.chunk_append.call(null,b__34412,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frisk_shell.re_com.views.event_list_item,item,checkbox_val,deb_data], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),item], null)));
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__34412),re_frisk_shell$re_com$views$events_scroller_$_iter__34409.call(null,cljs.core.chunk_rest.call(null,s__34410__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__34412),null);
}
} else {
var item = cljs.core.first.call(null,s__34410__$2);
return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frisk_shell.re_com.views.event_list_item,item,checkbox_val,deb_data], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),item], null)),re_frisk_shell$re_com$views$events_scroller_$_iter__34409.call(null,cljs.core.rest.call(null,s__34410__$2)));
}
} else {
return null;
}
...
return iter__27270__auto__.call(null,cljs.core.deref.call(null,filtered_events));
})()], null);
})], null));
});
...
return (function (p1__34414_SHARP_){
return cljs.core.get_in.call(null,p1__34414_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"trace","trace",-1082747415),new cljs.core.Keyword(null,"duration","duration",1444101068)], null));
...
return cljs.core.reset_BANG_.call(null,text_val,p1__34415_SHARP_);
...
return cljs.core.reset_BANG_.call(null,checkbox_val,p1__34416_SHARP_);
});})(checkbox_val,checkbox_sort_val,trace_QMARK_,text_val,sorted_events,filtered_events))
...
return cljs.core.reset_BANG_.call(null,checkbox_sort_val,p1__34417_SHARP_);
});})(checkbox_val,checkbox_sort_val,trace_QMARK_,text_val,sorted_events,filtered_events))
...
return cljs.core.swap_BANG_.call(null,deb_data,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"evnt-colors","evnt-colors",582185154),cljs.core.deref.call(null,evnt_key)], null),p1__34418_SHARP_.target.value);
});})(evnt_key,clr))
...
var len__27633__auto___34427 = arguments.length;
var i__27634__auto___34428 = (0);
while(true){
if((i__27634__auto___34428 < len__27633__auto___34427)){
args__27640__auto__.push((arguments[i__27634__auto___34428]));

var G__34429 = (i__27634__auto___34428 + (1));
i__27634__auto___34428 = G__34429;
continue;
} else {
}
break;
...
return re_frisk_shell.re_com.views.main.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),(arguments[(2)]),argseq__27641__auto__);
});

re_frisk_shell.re_com.views.main.cljs$core$IFn$_invoke$arity$variadic = (function (re_frame_data,re_frame_events,deb_data,p__34423){
var vec__34424 = p__34423;
var doc = cljs.core.nth.call(null,vec__34424,(0),null);
var imp_hndl = cljs.core.nth.call(null,vec__34424,(1),null);
var exp_hndl = cljs.core.nth.call(null,vec__34424,(2),null);
...
re_frisk_shell.re_com.views.main.cljs$lang$applyTo = (function (seq34419){
...
return re_frisk_shell.re_com.views.main.cljs$core$IFn$_invoke$arity$variadic(G__34420,G__34421,G__34422,seq34419__$3);
});


//# sourceMappingURL=views.js.map?rel=1553724328668
