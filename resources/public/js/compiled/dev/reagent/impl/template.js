...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__27087__auto__,writer__27088__auto__,opt__27089__auto__){
return cljs.core._write.call(null,writer__27088__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__29403 = o;
(G__29403[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__26450__auto__ = !((jsprops == null));
if(and__26450__auto__){
var and__26450__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__29409 = jsprops;
(G__29409["defaultValue"] = value);

(G__29409["onChange"] = ((function (G__29409,v,value,on_change){
return (function (p1__29408_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__29408_SHARP_);
});})(G__29409,v,value,on_change))
);
...
var vec__29412 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__29412,(0),null);
var id = cljs.core.nth.call(null,vec__29412,(1),null);
var class$ = cljs.core.nth.call(null,vec__29412,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___29416 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___29416 == null)){
} else {
var key_29417 = temp__4661__auto___29416;
(jsprops["key"] = key_29417);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__29418 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__29418["name"] = c);
...
var len__27633__auto___29423 = arguments.length;
var i__27634__auto___29424 = (0);
while(true){
if((i__27634__auto___29424 < len__27633__auto___29423)){
args__27640__auto__.push((arguments[i__27634__auto___29424]));

var G__29425 = (i__27634__auto___29424 + (1));
i__27634__auto___29424 = G__29425;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__27641__auto__);
});
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__29422,seq29421__$1);
});
...
break;
default:
var G__29428 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__29428;
continue;
...
var n__27409__auto___29430 = a.length;
var i_29431 = (0);
while(true){
if((i_29431 < n__27409__auto___29430)){
(a[i_29431] = reagent.impl.template.as_element.call(null,(a[i_29431])));
...
var a = cljs.core.into_array.call(null,s);
var n__27409__auto___29433 = a.length;
var i_29434 = (0);
while(true){
if((i_29434 < n__27409__auto___29433)){
var val_29435 = (a[i_29434]);
if((cljs.core.vector_QMARK_.call(null,val_29435)) && ((reagent.impl.template.key_from_vec.call(null,val_29435) == null))){
(o["no-key"] = true);
} else {
}

(a[i_29434] = reagent.impl.template.as_element.call(null,val_29435));

var G__29436 = (i_29434 + (1));
i_29434 = G__29436;
continue;
} else {
}
...
var ctx = ({});
var vec__29437 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__29437,(0),null);
var derefed = cljs.core.nth.call(null,vec__29437,(1),null);
...
var G__29440 = (cljs.core.count.call(null,argv) - first_child);
switch (G__29440) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__29440){
...
//# sourceMappingURL=template.js.map?rel=1553721075375
