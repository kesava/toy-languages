...
var vec__34856_34859 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_34860 = cljs.core.nth.call(null,vec__34856_34859,(0),null);
var only_after_34861 = cljs.core.nth.call(null,vec__34856_34859,(1),null);
var db_changed_QMARK__34862 = (!((only_before_34860 == null))) || (!((only_after_34861 == null)));
if(db_changed_QMARK__34862){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_34860);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_34861);
...
var map__34863 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__34863__$1 = ((((!((map__34863 == null)))?((((map__34863.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__34863.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__34863):map__34863);
var db = cljs.core.get.call(null,map__34863__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__34863__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__34865 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__34865__$1;
var event = cljs.core.get.call(null,map__34865__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__27633__auto___34868 = arguments.length;
var i__27634__auto___34869 = (0);
while(true){
if((i__27634__auto___34869 < len__27633__auto___34868)){
args__27640__auto__.push((arguments[i__27634__auto___34869]));

var G__34870 = (i__27634__auto___34869 + (1));
i__27634__auto___34869 = G__34870;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__27641__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq34867){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq34867));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__26462__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__27640__auto__ = [];
var len__27633__auto___34876 = arguments.length;
var i__27634__auto___34877 = (0);
while(true){
if((i__27634__auto___34877 < len__27633__auto___34876)){
args__27640__auto__.push((arguments[i__27634__auto___34877]));

var G__34878 = (i__27634__auto___34877 + (1));
i__27634__auto___34877 = G__34878;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__27641__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__34871_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__34872_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__34872_SHARP_);
});})(new_db,old_db,new_ins))
,in_paths);
var changed_ins_QMARK_ = (function (){var and__26450__auto__ = cljs.core.contains_QMARK_.call(null,re_frame.interceptor.get_effect.call(null,context),new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq34873){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__34874,G__34875,seq34873__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1553724329484
