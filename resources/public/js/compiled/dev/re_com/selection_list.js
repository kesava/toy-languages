...
var base_style__$1 = (cljs.core.truth_((function (){var and__26450__auto__ = selected_QMARK_;
...
var base_style__$2 = (cljs.core.truth_((function (){var and__26450__auto__ = selected_QMARK_;
if(cljs.core.truth_(and__26450__auto__)){
...
if(cljs.core.truth_((function (){var and__26450__auto__ = required_QMARK_;
if(cljs.core.truth_(and__26450__auto__)){
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__33767){
...
var disabled_QMARK_ = cljs.core.get.call(null,map__33768__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__33768__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var height = cljs.core.get.call(null,map__33768__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var item_renderer = cljs.core.get.call(null,map__33768__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
...
var required_QMARK_ = cljs.core.get.call(null,map__33768__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__33768__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var max_height = cljs.core.get.call(null,map__33768__$1,new cljs.core.Keyword(null,"max-height","max-height",-612563804));
var hide_border_QMARK_ = cljs.core.get.call(null,map__33768__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var width = cljs.core.get.call(null,map__33768__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var choices = cljs.core.get.call(null,map__33768__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__33768__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var multi_select_QMARK_ = cljs.core.get.call(null,map__33768__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__33768,map__33768__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_){
return (function (p1__33764_SHARP_){
return item_renderer.call(null,p1__33764_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__33768,map__33768__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__33768,map__33768__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_){
return (function (p1__33765_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__33765_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__33768,map__33768__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__33768,map__33768__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_){
return (function (p1__33766_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__33766_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__33768,map__33768__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_))
)),choices);
...
var len__27633__auto___33777 = arguments.length;
var i__27634__auto___33778 = (0);
while(true){
if((i__27634__auto___33778 < len__27633__auto___33777)){
args__27640__auto__.push((arguments[i__27634__auto___33778]));

var G__33779 = (i__27634__auto___33778 + (1));
i__27634__auto___33778 = G__33779;
continue;
} else {
}
break;
...
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(argseq__27641__auto__);
});

re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__33771){
...
var args = map__33772__$1;
if(cljs.core.truth_(((!(goog.DEBUG))?true:re_com.validate.validate_args.call(null,re_com.validate.extract_arg_data.call(null,re_com.selection_list.selection_list_args_desc),args,"selection-list")))){
} else {
throw (new Error("Assert failed: (validate-args-macro selection-list-args-desc args \"selection-list\")"));
}

return ((function (map__33772,map__33772__$1,args){
return (function() { 
var G__33780__delegate = function (p__33774){
...
while (G__33781__i < G__33781__a.length) {G__33781__a[G__33781__i] = arguments[G__33781__i + 0]; ++G__33781__i;}
  p__33774 = new cljs.core.IndexedSeq(G__33781__a,0,null);
} 
return G__33780__delegate.call(this,p__33774);};
G__33780.cljs$lang$maxFixedArity = 0;
G__33780.cljs$lang$applyTo = (function (arglist__33782){
var p__33774 = cljs.core.seq(arglist__33782);
return G__33780__delegate(p__33774);
});
G__33780.cljs$core$IFn$_invoke$arity$variadic = G__33780__delegate;
return G__33780;
})()
;
;})(map__33772,map__33772__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq33770){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq33770));
});


//# sourceMappingURL=selection_list.js.map?rel=1553724325991
