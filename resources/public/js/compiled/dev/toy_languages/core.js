...
var G__35441 = (new goog.History());
goog.events.listen(G__35441,goog.history.EventType.NAVIGATE,((function (G__35441){
return (function (event){
return secretary.core.dispatch_BANG_.call(null,event.token);
});})(G__35441))
);

G__35441.setEnabled(true);
...
var action__35309__auto___35452 = (function (params__35310__auto__){
if(cljs.core.map_QMARK_.call(null,params__35310__auto__)){
var map__35442 = params__35310__auto__;
...
var vec__35444 = params__35310__auto__;
return cljs.core.swap_BANG_.call(null,toy_languages.core.app_state,cljs.core.assoc,new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.Keyword(null,"home","home",-74557309));
} else {
return null;
}
...
secretary.core.add_route_BANG_.call(null,"/",action__35309__auto___35452);


var action__35309__auto___35453 = (function (params__35310__auto__){
if(cljs.core.map_QMARK_.call(null,params__35310__auto__)){
var map__35447 = params__35310__auto__;
...
if(cljs.core.vector_QMARK_.call(null,params__35310__auto__)){
var vec__35449 = params__35310__auto__;
return cljs.core.swap_BANG_.call(null,toy_languages.core.app_state,cljs.core.assoc,new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.Keyword(null,"about","about",1423892543));
} else {
return null;
}
...
secretary.core.add_route_BANG_.call(null,"/about",action__35309__auto___35453);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"textarea","textarea",-650375824),new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"class","class",-2030961996),"likeQuora",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref.call(null,value),new cljs.core.Keyword(null,"rows","rows",850049680),(9),new cljs.core.Keyword(null,"cols","cols",-1914801295),(50),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__35454_SHARP_){
return cljs.core.reset_BANG_.call(null,value,p1__35454_SHARP_.target.value);
})], null)], null);
});
toy_languages.core.editor_vector = reagent.core.atom.call(null,cljs.core.into.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["(define x 3)","(plus x 8)"], null),cljs.core.doall.call(null,cljs.core.map.call(null,(function (){
return [""].join('');
...
var c__27268__auto__ = cljs.core.chunk_first.call(null,s__35457__$2);
var size__27269__auto__ = cljs.core.count.call(null,c__27268__auto__);
var b__35459 = cljs.core.chunk_buffer.call(null,size__27269__auto__);
if((function (){var i__35458 = (0);
while(true){
if((i__35458 < size__27269__auto__)){
var i = cljs.core._nth.call(null,c__27268__auto__,i__35458);
cljs.core.chunk_append.call(null,b__35459,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tr","tr",-1424774646),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),(i + (1))], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"content-editable","content-editable",636764967),"true",new cljs.core.Keyword(null,"class","class",-2030961996),"likeQuora code-col",new cljs.core.Keyword(null,"on-input","on-input",-267523366),((function (i__35458,i,c__27268__auto__,size__27269__auto__,b__35459,s__35457__$2,temp__4657__auto__){
return (function (p1__35455_SHARP_){
console.log(p1__35455_SHARP_.target.innerHTML);

cljs.core.swap_BANG_.call(null,toy_languages.core.editor_vector,cljs.core.assoc,i,p1__35455_SHARP_.target.innerHTML);
...
});})(i__35458,i,c__27268__auto__,size__27269__auto__,b__35459,s__35457__$2,temp__4657__auto__))
...
return console.log(cljs.core.deref.call(null,toy_languages.core.result_vector));
});})(i,s__35457__$2,temp__4657__auto__))
], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"res-col"], null),cljs.core.get.call(null,cljs.core.deref.call(null,toy_languages.core.result_vector),i)], null)], null),toy_languages$core$editor_table_$_iter__35456.call(null,cljs.core.rest.call(null,s__35457__$2)));
}
} else {
return null;
}
...
//# sourceMappingURL=core.js.map?rel=1553724330436
