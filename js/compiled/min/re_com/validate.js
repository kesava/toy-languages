...
var G__17284 = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(obj)].join('');
var G__17285 = max_len;
return goog.string.truncate(G__17284,G__17285);
});
/**
...
var len__12081__auto___17287 = arguments.length;
var i__12082__auto___17288 = (0);
while(true){
if((i__12082__auto___17288 < len__12081__auto___17287)){
args__12088__auto__.push((arguments[i__12082__auto___17288]));

var G__17289 = (i__12082__auto___17288 + (1));
i__12082__auto___17288 = G__17289;
continue;
} else {
}
break;
...
return re_com.validate.log_error.cljs$core$IFn$_invoke$arity$variadic(argseq__12089__auto__);
});
...
re_com.validate.log_error.cljs$lang$applyTo = (function (seq17286){
return re_com.validate.log_error.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq17286));
});
...
var args__12088__auto__ = [];
var len__12081__auto___17291 = arguments.length;
var i__12082__auto___17292 = (0);
while(true){
if((i__12082__auto___17292 < len__12081__auto___17291)){
args__12088__auto__.push((arguments[i__12082__auto___17292]));

var G__17293 = (i__12082__auto___17292 + (1));
i__12082__auto___17292 = G__17293;
continue;
} else {
}
break;
...
var argseq__12089__auto__ = ((((0) < args__12088__auto__.length))?(new cljs.core.IndexedSeq(args__12088__auto__.slice((0)),(0),null)):null);
return re_com.validate.log_warning.cljs$core$IFn$_invoke$arity$variadic(argseq__12089__auto__);
});
...
re_com.validate.log_warning.cljs$lang$applyTo = (function (seq17290){
return re_com.validate.log_warning.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq17290));
});
...
var or__10921__auto__ = clojure.set.superset_QMARK_(defined_args,passed_args);
...
var or__10921__auto__ = clojure.set.superset_QMARK_(passed_args,required_args);
if(cljs.core.truth_(or__10921__auto__)){
return or__10921__auto__;
} else {
...
var validate_arg = (function (p__17294){
var vec__17295 = p__17294;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17295,(0),null);
var v_arg_def = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17295,(1),null);
...
var validate_result = (function (){var fexpr__17298 = cljs.core.cst$kw$validate_DASH_fn.cljs$core$IFn$_invoke$arity$1(v_arg_def);
return (fexpr__17298.cljs$core$IFn$_invoke$arity$1 ? fexpr__17298.cljs$core$IFn$_invoke$arity$1(arg_val) : fexpr__17298.call(null,arg_val));
})();
...
var G__17300 = log_msg_base;
var G__17301 = cljs.core.cst$kw$message.cljs$core$IFn$_invoke$arity$1(validate_result);
var G__17302 = ((warning_QMARK_)?comp_path:null);
var fexpr__17299 = ((warning_QMARK_)?re_com.validate.log_warning:re_com.validate.log_error);
...
var args__12088__auto__ = [];
var len__12081__auto___17306 = arguments.length;
var i__12082__auto___17307 = (0);
while(true){
if((i__12082__auto___17307 < len__12081__auto___17306)){
args__12088__auto__.push((arguments[i__12082__auto___17307]));

var G__17308 = (i__12082__auto___17307 + (1));
i__12082__auto___17307 = G__17308;
continue;
} else {
}
break;
...
return re_com.validate.validate_args.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__12089__auto__);
});
...
var and__10909__auto__ = re_com.validate.arg_names_valid_QMARK_(cljs.core.cst$kw$arg_DASH_names.cljs$core$IFn$_invoke$arity$1(arg_defs),passed_arg_keys);
if(cljs.core.truth_(and__10909__auto__)){
var and__10909__auto____$1 = re_com.validate.required_args_passed_QMARK_(cljs.core.cst$kw$required_DASH_args.cljs$core$IFn$_invoke$arity$1(arg_defs),passed_arg_keys);
if(cljs.core.truth_(and__10909__auto____$1)){
return re_com.validate.validate_fns_pass_QMARK_(cljs.core.cst$kw$validated_DASH_args.cljs$core$IFn$_invoke$arity$1(arg_defs),passed_args,cljs.core.first(component_name));
} else {
...
re_com.validate.validate_args.cljs$lang$applyTo = (function (seq17303){
...
return re_com.validate.validate_args.cljs$core$IFn$_invoke$arity$variadic(G__17304,G__17305,seq17303__$2);
});
...
var or__10921__auto__ = cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([arg__$1]),valid_set),null);
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$span], null),cljs.core.interpose.cljs$core$IFn$_invoke$arity$2(", ",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__17309_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[cljs.core.cst$kw$code,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__17309_SHARP_)].join('')],null));
}),codes)));
});
...
var arg__$1 = re_com.util.deref_or_value_peek(arg);
var and__10909__auto__ = cljs.core.map_QMARK_(arg__$1);
if(and__10909__auto__){
var arg_keys = cljs.core.keys(arg__$1);
var or__10921__auto__ = clojure.set.superset_QMARK_(re_com.validate.css_styles,arg_keys);
if(cljs.core.truth_(or__10921__auto__)){
return or__10921__auto__;
} else {
...
return (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(attr__$1.indexOf(p1__17310_SHARP_),(0))) && ((cljs.core.count(attr__$1) > cljs.core.count(p1__17310_SHARP_)));
});})(attr__$1))
;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__17311_SHARP_),"-"].join('');
});})(attr__$1,ext_QMARK_))
...
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__17312_SHARP_){
var or__10921__auto__ = (re_com.validate.html_attrs.cljs$core$IFn$_invoke$arity$1 ? re_com.validate.html_attrs.cljs$core$IFn$_invoke$arity$1(p1__17312_SHARP_) : re_com.validate.html_attrs.call(null,p1__17312_SHARP_));
if(cljs.core.truth_(or__10921__auto__)){
return or__10921__auto__;
} else {
return re_com.validate.extension_attribute_QMARK_(p1__17312_SHARP_);
}
}),attrs);
});
/**
...
var result = ((contains_class_QMARK_)?":class not allowed in :attr argument":((contains_style_QMARK_)?":style not allowed in :attr argument":(function (){var temp__4657__auto__ = cljs.core.not_empty(re_com.validate.invalid_html_attrs(arg_keys));
...
var or__10921__auto__ = (result == null);
if(or__10921__auto__){
return or__10921__auto__;
} else {
